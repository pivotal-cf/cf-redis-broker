...
func (fake *FakeProcessKiller) Kill(arg1 int) error {
	fake.killMutex.Lock()
...
func (fake *FakeProcessKiller) KillCalls(stub func(int) error) {
	fake.killMutex.Lock()
	defer fake.killMutex.Unlock()
	fake.KillStub = stub
}

func (fake *FakeProcessKiller) KillArgsForCall(i int) int {
	fake.killMutex.RLock()
	defer fake.killMutex.RUnlock()
...
var _ redis.ProcessKiller = new(FakeProcessKiller)
