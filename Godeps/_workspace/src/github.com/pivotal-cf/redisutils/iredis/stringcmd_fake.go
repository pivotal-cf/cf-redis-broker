...
//Err ...
func (fake *StringCmdFake) Err() error {
	fake.errMutex.Lock()
...
//ErrCallCount ...
func (fake *StringCmdFake) ErrCallCount() int {
	fake.errMutex.RLock()
...
//ErrReturns ...
func (fake *StringCmdFake) ErrReturns(result1 error) {
	fake.ErrStub = nil
...
func (fake *StringCmdFake) String() string {
...
//StringCallCount ...
func (fake *StringCmdFake) StringCallCount() int {
...
//StringReturns ...
func (fake *StringCmdFake) StringReturns(result1 string) {
	fake.StringStub = nil
...
//Val ...
func (fake *StringCmdFake) Val() string {
	fake.valMutex.Lock()
...
//ValCallCount ...
func (fake *StringCmdFake) ValCallCount() int {
	fake.valMutex.RLock()
...
//ValReturns ...
func (fake *StringCmdFake) ValReturns(result1 string) {
	fake.ValStub = nil
